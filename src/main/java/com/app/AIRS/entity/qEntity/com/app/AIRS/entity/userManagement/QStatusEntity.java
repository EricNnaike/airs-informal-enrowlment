...
public class QStatusEntity extends EntityPathBase<StatusEntity> {
    ...
    private static final long serialVersionUID = -1821342091L;
    ...
    public final EnumPath<com.app.AIRS.Enum.GenericStatusConstant> status = createEnum("status", com.app.AIRS.Enum.GenericStatusConstant.class);
