...
public class QPortalUser extends EntityPathBase<PortalUser> {
    ...
    private static final long serialVersionUID = 1632826967L;
    ...
    public final EnumPath<com.app.AIRS.Enum.Gender> gender = createEnum("gender", com.app.AIRS.Enum.Gender.class);
    ...
    public final com.app.AIRS.entity.QLga lga;
    ...
    public QPortalUser(Class<? extends PortalUser> type, PathMetadata metadata, PathInits inits) {
        ...
        this.lga = inits.isInitialized("lga") ? new com.app.AIRS.entity.QLga(forProperty("lga")) : null;
