...
public class QFileModel extends EntityPathBase<FileModel> {
    ...
    private static final long serialVersionUID = 621353805L;

    public static final QFileModel fileModel = new QFileModel("fileModel");

    public final StringPath code = createString("code");

    public final EnumPath<com.app.AIRS.Enum.DataStorageConstant> dataStorageConstant = createEnum("dataStorageConstant", com.app.AIRS.Enum.DataStorageConstant.class);
