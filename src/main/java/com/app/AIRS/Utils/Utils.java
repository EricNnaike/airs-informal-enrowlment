...
//    }
    ...
    public static void Confirm(String userNumber,  String sector, String tin, String name){
        Twilio.init("AC932aa126e7abb759c35a15a388466348", "3f957f2e812d46035e99122e6d765fde");
        Message.creator(new PhoneNumber(userNumber), new PhoneNumber("+16815081808"), "Dear "+ name + "\n"+" " +
                "Thank you for completing your " + sector + " Enumeration. Your " +sector+ " ID is "+tin + ", use this to pay for your " + sector +" tax/levy \n"+
                "AIRS.").create();
    }
